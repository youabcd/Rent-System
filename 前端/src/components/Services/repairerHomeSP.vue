    ...
    export default {
        ...
        data() {
            return{
                ...
                userAvatar: 'http://imagemxc.test.upcdn.net//工人.png',
                showNameEdit: false,
                showSexEdit: false,
                showPhoneEdit: false,
        ...
        methods: {
            ...
            submitPhoneNumber(){
				var _this = this;
				axios.get('/changerepairmanphone',{
				params: {
				  UserId:_this.userId,
